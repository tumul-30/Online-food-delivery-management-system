    ...
    <div class="wrapper">
        ...
        <form action="" method="POST" enctype = "multipart/form-data">
            <table class="tbl-30">
                <tr>
                    <td>Title:</td>
                    <td><input type="text" name="title" placeholder="tile of the food"></td>
                </tr>
        ...
        <?php
            if(isset($_POST['submit']))
            {
                ...
                //upload the image if selected or button is clicked or not
                if(isset($_FILES['image']['name']))
                {
                    $image_name=$_FILES['image']['name'];//image name
                    if($image_name !="")//check if image s selected or not
                    {
                ...
                $sql2 = "INSERT INTO tbl_food SET
                 ...
                 if($res == true)
                 {
                    $_SESSION['add']= "<div style= 'color:#009432;'><b>Food Added successfully</b></div>";
                    header('location:'.SITEURL.'admin/manage-food.php');
                 }
                 else
                 {
                    $_SESSION['add']= "<div style= 'color:red;'><b>failed to add food</b></div>";
                    header('location:'.SITEURL.'admin/manage-food.php');
                 }
            }
        ?>
