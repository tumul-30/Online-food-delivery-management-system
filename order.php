        ...
        <div class="container">
            ...
            <?php
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    $order_date = date("Y-m-d h:i:sa");//h=hour i= min , s = second , a =am/pm
                    $status = "Ordered";
                    ...
                    if($res2 == true)
                    {
                        $_SESSION['order'] = "<div style= 'color:#009432;'><b>Order Placed Successfully</b></div>";
                        header('location:'.SITEURL);
                    }
                    else
                    {
                        $_SESSION['order'] = "<div style= 'color:red;'><b>Failed to Order</b></div>";
                        header('location:'.SITEURL);
                    }
